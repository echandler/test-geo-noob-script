...
// ==/UserScript==
    ...
    let observer = new MutationObserver(mutationRecords => {
        ...
        // if (ls.playAlong){
        //     const playAlongBtn = document.querySelector(`[alt="Play Along"]`);
        //     if (playAlongBtn) playAlongBtn.click();
        // }
    });
        ...
        html: `
            ...
            <div class="_challengeSpecs">
                ...
                <div id="_miscStuff" style="margin: 1em 0em;">
                    ...
                    <label for="_playAlong"><input type="checkbox" id="_playAlong">Play Along?</label>
                </div>
...
If the timer or play along doesn't work, try going back to the game setting page, by pressing the back button, and DO A HARD REFRESH by:
